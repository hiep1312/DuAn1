...
<!-- Hero Section -->
<section class="hero-section d-flex align-items-center text-light" style="z-index: 1">
      <div class="color-cover custom-padding">
        <div class="container overflow-hidden">
          <div class="row">
            <div class="col-lg-7">
              <div class="transition-fade-left">
                <h1
    ...
    <section
      ...
      data-aos-offset="0"
      class="banner-section text-center py-4"
    >
      <div class="container">
        <p
          data-aos="fade-up"
    ...
    <!-- Our Works Section -->
    <section class="our-works-section custom-padding">
      <div class="container overflow-hidden">
        <div class="row mb-4">
          <div class="col-md-6">
        ...
        <div class="row g-5 mt-4">
          ...
          <!-- Col 2 -->
          <div class="col-12 col-md-6 col-lg d-flex flex-column mt-0 mt-lg-4">
            <div
              data-aos="fade-up"
              data-aos-delay="200"
          ...
          <!-- Col 3 -->
          <div
            class="col-12 col-md-6 col-lg d-flex w-100 justify-content-md-between align-items-md-start flex-column flex-md-row flex-lg-column mt-0 mt-lg-4"
          >
            <div
              data-aos="fade-up"
              data-aos-delay="400"
    ...
    <section class="what-we-do-section bg-primary-custom custom-padding">
      <div class="container overflow-hidden">
        ...
        <div class="row text-center g-4 mt-4">
          ...
          <div data-aos="fade-up" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-clone" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                rebranding
              </h5>
              <p class="text-light pe-md-4 mt-3">
          ...
          <div data-aos="fade-up" data-aos-delay="200" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-comment-dots" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                social media
              </h5>
              <p class="text-light pe-md-4 mt-3">
          ...
          <div data-aos="fade-up" data-aos-delay="400" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-images" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                graphic design
              </h5>
              <p class="text-light pe-md-4 mt-3">
          ...
          <div data-aos="fade-up" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-compass" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                website design
              </h5>
              <p class="text-light pe-md-4 mt-3">
          ...
          <div data-aos="fade-up" data-aos-delay="200" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-keyboard" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                Copywriting
              </h5>
              <p class="text-light pe-md-4 mt-3">
          ...
          <div data-aos="fade-up" data-aos-delay="400" class="col-md-4">
            <div class="icon-box text-md-start">
              <i class="fa-regular fa-bookmark" style="color: #c4fb6d"></i>
              <h5 class="fw-light text-light mt-4 h5-text font-krona-one text-uppercase">
                product launch
              </h5>
              <p class="text-light pe-md-4 mt-3">
    ...
    <section class="services-table-section custom-padding">
      <div class="container overflow-hidden">
        <div class="row justify-content-center">
          <div class="col">
            <div class="table-responsive">
              <table class="table table-borderless overflow-hidden text-light">
                <thead class="font-krona-one">
                  <tr data-aos="fade-up">
                    <th class="pb-4 fw-light h4-text" style="width: 40%">
                      SERVICES
                    </th>
                    <th class="pb-4 fw-light h4-text" style="width: 20%">
                      YEAR
                    </th>
                    <th class="pb-4 fw-light h4-text" style="width: 40%">
                      CLIENT
                ...
                <tbody class="h5-text font-krona-one">
                  <tr data-aos="fade-up">
                    <td class="py-4" style="text-wrap: nowrap">
                      PRODUCT DEVELOPMENT
                    </td>
                    <td class="py-4" style="text-wrap: nowrap">2022</td>
                    <td class="py-4" style="text-wrap: nowrap">
                  ...
                  <tr data-aos="fade-up">
                    ...
                    <td class="py-4" style="text-wrap: nowrap">2023</td>
                    <td class="py-4" style="text-wrap: nowrap">
                      REAL TECH BIZ EUROPE
                    </td>
                  </tr>
                  <tr data-aos="fade-up">
                    <td class="pt-4" style="text-wrap: nowrap">
                      PRODUCT BRANDING
                    </td>
                    <td class="pt-4" style="text-wrap: nowrap">2023</td>
                    <td class="pt-4" style="text-wrap: nowrap">
                      STOREPACK CENTER GLOBAL
                    </td>
                  </tr>
                </tbody>
              </table>
    ...
    <!-- Reviews Section -->
    <section class="reviews-section bg-secondary-opacity-custom">
      <div class="container-fluid overflow-hidden p-0">
        <div class="row align-items-center">
          ...
          <!-- Slider -->
          <div class="col-lg-6 pe-0 review-ps-custom" style="width: 570px">
            <div
              id="reviewCarousel"
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <div class="review-box p-4">
                    <h2
                      data-aos="fade-left"
                      class="text-uppercase text-light mb-3 font-krona-one h2-text"
                    >
                      Reviews
                    </h2>
                    ...
                    <p
                      data-aos="fade-up"
                      class="text-light mb-4 sub-text-medium"
                    >
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <div data-aos="fade-up" class="d-flex align-items-center">
                      ...
                      >
                        <div>
                          <p class="mb-0 font-krona-one fw-light">
                            Mike Lewis<br />
                          </p>
                          <p class="text-secondary-color mb-0">Twitter</p>
                        </div>
                ...
                <div class="carousel-item">
                  <div class="review-box p-4">
                    ...
                    <p
                      ...
                      class="text-light mb-4 sub-text-medium"
                    >
                      Another review content goes here. Lorem ipsum dolor sit
                    ...
                    <div data-aos="fade-up" class="d-flex align-items-center">
                      ...
                      >
                        <div>
                          ...
                          <p class="text-secondary-color mb-0">Facebook</p>
                        </div>
                        <img src="assets/icons/IconBacktik.png" alt="" />
                      </div>
                    </div>
      ...
      <div class="container overflow-hidden">
        <div class="row pb-5">
          ...
          <div data-aos="fade-up" class="col-lg-6">
            <h2 class="section-title font-krona-one h2-text">Pricing</h2>
          </div>
          <!-- Col 2 -->
          <div data-aos-duration="1300" class="col-lg-6 text-start">
            <p data-aos="fade-up">
