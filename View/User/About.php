...
?>
    ...
    <!-- Section 3 - About Us -->
    <section class="bg-primary-custom" style="z-index: 1">
    ...
    <section class="text-white px-2 px-lg-0 custom-height-about">
        <div class="container overflow-hidden">
            <!-- Row -->
            <div class="row align-items-center custom-height-about">
                <!-- Col 1 -->
                <div
                ...
                <div class="col-lg-6 padding-left-c margin-short-c">
                    <h2
                        ...
                        Cam kết và Dịch vụ của chúng tôi
                    </h2>
                    <p data-aos="fade-up" data-aos-delay="200">
                        Chất lượng đảm bảo:
                    <p class="justify-text">Mỗi sản phẩm chúng tôi cung cấp đều được chọn lọc kỹ càng từ các nhà sản xuất
                        uy tín, đảm bảo chất lượng âm thanh tuyệt vời và độ bền cao. Bên cạnh đó, chúng
                        tôi cung cấp các dịch vụ bảo hành, bảo trì để bạn yên tâm sử dụng lâu dài.</p>
                    </p>
                    <p data-aos="fade-up" data-aos-delay="200">
