document.addEventListener("DOMContentLoaded", () => {
    ...
    if(!localStorage.getItem('sessionId')){
        ...
        alert.className = "alert alert-warning d-flex align-items-center mt-4";
        alert.role = "alert";
        ...
        alert.innerHTML = `
          ...
          <div>
            Bạn cần đăng nhập để chỉnh sửa tài khoản!
          </div>`;
        formAdd.parentElement.parentElement.replaceWith(alert);
    }
