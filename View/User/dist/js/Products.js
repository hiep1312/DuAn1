        ...
        data.data.forEach(item => {
            ...
            frameProduct.innerHTML = `
                    <div class="card h-100 border border-light bg-white">
                        <img src="${item.imageProducts.filter(img => img.location===0)?.[0] ?? `https://news.khangz.com/wp-content/uploads/2021/10/404-not-found-la-gi-1.jpg`}" class="card-img-top" style="max-height: 250px" alt="Ảnh sản phẩm">
