...
<<<<<<< HEAD
                <p class="mb-0 opacity-50">Total Pending Orders</p>
=======
                <p class="mb-0 opacity-50">Đơn hàng đang chờ xử lý</p>
>>>>>>> aa3d8fab086c3fe93b328442f8e1c87bdfd4ff0e
              </div>
            </div>
          </div>
...
<<<<<<< HEAD
  ...
  ?>
  <script src="<?= $BASE_URL ?>View/Admin/assets/js/plugins/apexcharts.min.js"></script>
  <script src="<?= $BASE_URL ?>View/Admin/assets/js/pages/dashboard-default.js"></script>
</body>
