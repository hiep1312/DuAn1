          ...
          <div class="card my-5">
            <div class="card-body">
              ...
              <div class="d-flex mt-1 justify-content-between">
                ...
                <h5 class="text-secondary"><a role="button" style="text-decoration: none;" href="./forgot_pass.php">Quên mật khẩu?</a></h5>
              </div>
              <div class="d-grid mt-4">
                <button type="button" class="btn btn-secondary"><a role="button" style="text-decoration: none;" href="../../../User/Home1.php">Đăng nhập</a></button>
              </div>
              <hr >
