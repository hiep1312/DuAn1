        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Chỉnh sửa tin tức</h1>
                ...
                <div class="modal-body">
                    <form class="row g-3" id="formEdit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 my-2">
                            <label for="image_url" class="form-label">Nội dung: </label>
                            <input type="file" name="image_url"  id="image_url" class="form-control" placeholder="Mời bạn nhập ảnh bài viết">
                        </div>
                        <div class="col-md-6 my-2">
                            <label for="created_at" class="form-label">Ngày tạo tin tức: </label>
                            <input type="date" name="created_at"  id="created_at" class="form-control" placeholder="Mời bạn nhập ảnh bài viết">
                        </div>
                        <div class="col-md-6 my-2">
                            <img src=""   id="img" style="max-height: 100px; max-width: 200px" alt>
                        </div>
                    </form>
                </div>
...
?>
<script src="<?= $BASE_URL ?>View/Admin/assets/js/mainNews.js"></script>
</body>
</html>