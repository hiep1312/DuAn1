...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Thêm list khuyến mãi</li>
                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <h1 class="my-4">Thêm list khuyến mãi</h1>
    ...
    include $BASE_URL . "View/Admin/components/footer-js.php"
        ?>
    <script src="<?= $BASE_URL ?>View/Admin/assets/js/Mypromotions.js"></script>
</body>
