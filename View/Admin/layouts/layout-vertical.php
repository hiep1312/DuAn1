...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    ...
    <a href="../../index.php" class="b-brand text-primary">
        ...
        <img src="../../assets/images/logo-dark.svg" alt="anhloi" class="logo">
      </a>
    </div>
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="../../dashboard/chart/index.php" class="pc-link"><span class="pc-micon"><i class="ti ti-dashboard"></i></span><span
        ...
        <li class="pc-item">
          <a href="../../elements/quanlytintuc/list.php" class="pc-link">
